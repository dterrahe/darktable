...
// #define glib_autoptr_clear_GtkEventBox(...)
...
typedef struct {} GtkMenu;
typedef struct {} GtkMenuItem;
typedef struct {} GtkMenuShell;
typedef struct {} GdkDragContext;
typedef struct {} GdkVisual;
typedef struct {} GtkSelectionData;
typedef struct {} GtkWidgetPath;
typedef struct {} GdkKeymap;
typedef struct {} GtkTargetList;
typedef struct {} GtkFileChooserButton;
typedef struct {} GtkRadioButton;

typedef struct GtkWidgetClassOld
{
  gpointer get_preferred_height;
  gpointer get_preferred_width;
  gpointer get_preferred_height_for_width;
  gpointer draw;
  gpointer destroy;
  gpointer enter_notify_event;
  gpointer leave_notify_event;
  gpointer button_press_event;
  gpointer button_release_event;
  gpointer motion_notify_event;
  gpointer scroll_event;
  gpointer key_press_event;
  gpointer get_request_mode;
} GtkWidgetClassOld;
#define GtkWidgetClass GtkWidgetClassOld
typedef enum
{
  GDK_X_CURSOR 		  = 0,
  GDK_ARROW 		  = 2,
...
#define gtk_bin_get_child(...) NULL
#define gtk_bin_get_child(...) NULL
#define gtk_box_pack_end(...)
...
#define gtk_event_controller_motion_new(...) NULL
...
#define gtk_paned_pack1(...)
#define gtk_paned_pack2(...)
...
#define gtk_scrolled_window_new(...) NULL
...
#define gtk_style_context_get_border(...)
#define gtk_style_context_get_color(...)
#define gtk_style_context_get_margin(...)
#define gtk_style_context_get_padding(...)
...
#define gtk_widget_get_tooltip_markup(...) NULL
...
#define GDK_DOUBLE_BUTTON_PRESS 0123
#define GDK_TRIPLE_BUTTON_PRESS 0124
